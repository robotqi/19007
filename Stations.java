...
public class Stations
{
    ...
    public void staIndex()throws Exception{
        ...
        String strFilePath = "C:\\Users\\Chelsea\\A19007\\Data\\FBIN.txt";
        String strRecord = "";
     ...
     * @param intIndex hands the method station selection index
     * @return strWeather containing the entire weather string
     */
    public String getStaWea(int intIndex)
    {
        String strStaWeather = staList.get(intIndex);
